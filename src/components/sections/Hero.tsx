...
export function Hero() {
  return (
    <header className="relative flex min-h-dvh w-full min-w-0 flex-col overflow-x-hidden bg-[#050505] pb-[env(safe-area-inset-bottom,0px)] text-white lg:h-dvh lg:max-h-dvh lg:min-h-0 lg:overflow-hidden">
      ...
      <div className="layout-container scale-exempt relative z-10 flex min-h-0 w-full min-w-0 max-w-full flex-1 flex-col items-center justify-center py-6 sm:py-8 lg:py-9 xl:py-10">
        <div className="grid min-h-0 w-full min-w-0 max-w-full auto-rows-min items-center justify-items-stretch gap-y-7 gap-x-0 sm:gap-y-10 lg:grid-cols-12 lg:items-center lg:gap-x-10 lg:gap-y-8 xl:gap-x-12">
          ...
          <div className="order-1 flex min-h-0 w-full min-w-0 max-w-lg flex-col items-center justify-center justify-self-center px-0.5 sm:max-w-xl sm:px-0 lg:order-none lg:col-span-6 lg:col-start-7 lg:max-w-none lg:items-stretch lg:justify-self-stretch lg:pl-1 lg:pr-2 xl:pl-2 xl:pr-3">
            <motion.div
